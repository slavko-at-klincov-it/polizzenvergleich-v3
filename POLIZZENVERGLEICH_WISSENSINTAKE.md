...
- Entscheidung: Vorhandene Governor-Gruppierung,
  ...
  positionsunabhängige Gruppen erweitern; keine neue Architektur. Die
  Umsetzung liegt in V67/V16/V29 vor. Der echte gespeicherte Fehlerfall
  bestand mit vier Requirements, exakt drei Governor-Zielen und ohne
  Scope-Leak zum vorangehenden Item. Der vollständige Replay der ersten fünf
  Batches bestand 5/5 mit null neuen Modellaufrufen. Der exakte
  V3.8.5-Release-Kandidat
  `b19df17def47e02f3897da36899fbc4393c0ac3c` bestand auf dem Mac Studio
  211/211 Suites, 3.062/3.062 Tests, alle drei Lints, Prisma,
...
- Ergebnis: Syntax und Prettier sowie der vollständige A-Referenzvertrag
  bestanden auf dem Mac Studio mit 395/395 Tests. Der echte gespeicherte
