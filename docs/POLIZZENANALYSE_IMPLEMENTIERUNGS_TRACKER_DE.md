...
### 133.11 Change Brief: LF-Einzelziel-Parallelität ohne Cross-Target-Batch

Nutzerproblem / gewünschtes Ergebnis: Der vollständige gerichtete LF-Lauf mit
einem A- und neun B-Dokumenten soll weiterhin alle 283 A-Zeilen in
unveränderter Reihenfolge prüfen und eine Kunden-XLSX erzeugen, aber sich der
Wandzeit des dokumentierten symmetrischen 27-Minuten-Laufs annähern.

Beobachtete Evidenz: Der erfolgreiche 1+9-Lauf auf `a2cc45a45` verarbeitete
117 Dokument-Kategorie-Einheiten. Darin liefen 452 Triage- und 161
Wirkungsaufrufe, zusammen 613 Modellaufrufe und 3.595,439 Sekunden gemessene
Providerzeit. Die Verteilung ist stark dokumentabhängig; B-01 verursachte 321
und B-09 weitere 126 Aufrufe. Anzeige und XLSX-Materialisierung sind nicht der
Engpass.

Root-Cause-Klasse: Prozess und Ressourcen. Die Einzelelemente werden trotz
voneinander unabhängiger, servergebundener Payloads vollständig seriell
ausgeführt; LM Studio ist zugleich auf eine Parallelvorhersage begrenzt.

Betroffene Verträge: INV-003, INV-004, INV-008, INV-011, FAIL-004, FAIL-005
und der Performanceentscheid vom 31. August 2026. Der dort verworfene
Cross-Target-Batch bleibt verworfen.

Callers, Datenfluss und Seiteneffekte: Der Vergleichsworker ruft für jedes
B-Dokument den Referenzrunner auf. Dieser startet pro Kategorie weiterhin
Triage, Wirkungsprüfung und Materialisierung in derselben Reihenfolge. Nur
innerhalb einer Modellphase dürfen höchstens zwei bereits getrennte
Einzelziel-Prompts gleichzeitig laufen. Jeder Prompt behält eigene erlaubte
IDs, eigenen Parser und eigene Retries. Ergebnisse werden vor Persistenz in
kanonischer Zielreihenfolge zusammengeführt. Die Parallelitätszahl wird Teil
des Resume-Vertrags. Der symmetrische Runner bleibt bei Einzelziel-Parallelität
eins. Der finale Workbook- und Archivvertrag bleibt unverändert.

Scope und Nicht-Ziele: Keine Reduktion der 283 Zeilen, keine Auswahl nur
positiver Treffer, kein gemeinsamer Prompt für verschiedene Targets, keine
Lockerung von Validatoren, Quellenbindung oder Fehlerabbruch. Ein fachlicher
Qualitätsgewinn und ein 99-Prozent-Nachweis sind ausdrücklich keine Aussage
dieses Inkrements.

Riskanteste Annahme: Zwei gleichzeitige MLX-Vorhersagen auf dem M2 Max mit
32 GB bleiben speicherstabil und liefern bei Temperatur null dieselben
servervalidierten Einzelergebnisse wie der serielle Pfad. Bei OOM, Swap,
Parserdrift, zusätzlichen Retries oder Ergebnisabweichung bleibt
Parallelität eins der sichere Rückfallvertrag.

Messbare Verbesserung / Abbruchgrenze: Ziel ist mindestens 30 Prozent weniger
Wandzeit auf eingefrorenen Realpayloads und anschließend ein vollständiger
1+9-Lauf. Harte Abbruchkriterien sind irgendeine andere servervalidierte
Triage-/Wirkungsentscheidung, geänderte Candidate-IDs oder Quellen, fehlende
A-Zeilen, andere A-Reihenfolge, instabile Runtime oder fehlender XLSX-Export.

Realstrukturnahe Regression: Zuerst seriell gegen zweispurig auf exakt
eingefrorenen Payloads des abgeschlossenen 1+9-Laufs, danach vollständiger
neuer 1+9-Produktlauf auf dem exakten Kandidaten-SHA. Zusätzlich bleiben die
vollständigen statischen Gates und der symmetrische 1+1-Nichtregressionspfad
verbindlich.

Notwendiger Wissens-Write-back: Messwerte und Go/No-Go werden nach dem
Mac-Studio-Canary in Tests und Erkenntnisse sowie hier als Resultat ergänzt.
