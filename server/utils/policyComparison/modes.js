...
const POLICY_COMPARISON_MODES = Object.freeze([
  Object.freeze({
    ...
    description:
      "Das Referenzpaket A dynamisch und vollständig in fachliche Ergebniszeilen zerlegen und ausschließlich dazu quellengebundene Gegenstücke im Dokumentpaket B suchen.",
    direction: "A_TO_B",
    sideALabel: "LF-IMMO-Referenzpaket A",
