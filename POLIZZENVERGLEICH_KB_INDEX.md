...
| Aktueller V3-Beweisstand | RC33 aktiviert den gemeinsamen evidenzgebundenen Pfad für alle acht Ansichten und terminiert auf LF/WEVIG 640/640 Zeilen. Der V3.2.1/RC33-Vergleich zeigt den Fehlertypwechsel zwischen breitem Recall und enger Faktenbindung. R1 gewinnt vier bekannte LW-Zeilen kontrolliert zurück. V3.3.1 ergänzt breite `3000/250`-Chunks plus Dinghy ausschließlich als Navigation zu exakten servervalidierten Hybridspans. Auf WEVIG/Qwen 27B verbessert sich genau HP-12, die übrigen 35 HP-Zeilen bleiben stabil; GRAWE und UNIQA lassen als Negativkontrollen 0 Hybridkandidaten zu. Das ist ein begrenzter Vertikalbeweis, keine 99-Prozent- oder Fremdversichererfreigabe. | [V3.3.1-Releasevertrag](../polizzenvergleich-v3/docs/RELEASE_V3.3.1_DE.md), [V3-Tracker, Abschnitt 65](../polizzenvergleich-v3/docs/POLIZZENANALYSE_IMPLEMENTIERUNGS_TRACKER_DE.md#65-v331-breites-chunking-als-evidenzgebundener-kandidatenfallback), [Tests, Abschnitt 42](./POLIZZENVERGLEICH_TESTS_UND_ERKENNTNISSE.md#42-v331--evidenzgebundener-hybridfallback) |
