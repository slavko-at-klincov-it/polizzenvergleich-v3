...
| Aktueller V3-Beweisstand              | Der technische Kundenstand ist `v3.7.1` / `db9f047e8`: zwei getrennte Workspace-Laufverträge, unveränderter symmetrischer 224-Zeilen-Pfad und gerichteter LF-Pfad mit 283 A-Zeilen. Der finale bekannte 1-A-plus-9-B-Replay verarbeitete 10/10 Dokumente und 117/117 B-Kategorieprüfungen in 119,799 Sekunden mit 610 validierten Cachetreffern und null Modellaufrufen. Artefaktset, API-Readback, XLSX und A-Stabilität bestanden; das Kunden-Deployment und der Doctor waren grün. Ein erster Lauf mit unbekannten Dokumenten wird dadurch nicht beschleunigt. Die Fixtures sind kein Versicherer-Holdout und kein 99-Prozent-Nachweis. | [V3.7.1-Release](../polizzenvergleich-v3/docs/RELEASE_V3.7.1_DE.md), [Tests, Abschnitt 59](./POLIZZENVERGLEICH_TESTS_UND_ERKENNTNISSE.md#59-v371-lf-1-plus-9-replay-cache-und-kundendeployment), [ADR-030](./POLIZZENVERGLEICH_ENTSCHEIDUNGEN.md#adr-030-validierte-identische-lf-wiederholungen-cachen-statt-zeilen-zu-filtern-oder-ziele-zu-batchen) |
...
| Aktuelles Kundenprofil und Export     | Neue A/B-Läufe verarbeiten genau VS/FE/LW/ST/EL mit 224 Zeilen. Der Download besitzt ein Blatt mit 17 Kundenspalten; `KI-Ergebnis` ist eine deterministische, fail-closed Präsentation der servereigenen Punktentscheidung. Technische Regeln und Suchaudits bleiben im privaten JSON. Historische Acht-Kategorien-Ergebnisse bleiben lesbar.                                                                                                                                                                                                                                                                                                                                                                                                       | [ADR-023](./POLIZZENVERGLEICH_ENTSCHEIDUNGEN.md#adr-023-produktives-fünf-kategorien-profil-und-einblatt-kundenexport), [Tests, Abschnitt 47](./POLIZZENVERGLEICH_TESTS_UND_ERKENNTNISSE.md#47-fünf-kategorien-profil-und-einblatt-export)                                                              |
...
| `INV-007` | „Besser“ ist nur punktweise innerhalb desselben atomaren Vergleichsscopes und einer versionierten Serverregel zulässig. Unqualifiziert fehlender Beleg ist kein Nachteil; es gibt keinen Gesamtsieger.                                                                                                                                                                                        | [ADR-021](./POLIZZENVERGLEICH_ENTSCHEIDUNGEN.md#adr-021-vorteile-sind-punktweise-atomar-und-regelgebunden)                                                                                                                         |
