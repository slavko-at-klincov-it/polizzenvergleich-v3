...
| Aktueller V3-Beweisstand | RC33 aktiviert den gemeinsamen evidenzgebundenen Pfad für alle acht Ansichten und terminiert auf LF/WEVIG 640/640 Zeilen. V3.3.1 ergänzt breite Chunks nur als Navigation zu exakten Hybridspans. Der erste LF-gegen-neun-WEVIG-Paketlauf materialisierte 3.200 Roh- und 320 Paketzeilen; vier falsche Rangfolge-Fälle wurden anschließend durch allgemeine Wert-, Scope- und Polaritätsverträge korrigiert. Ergebnisschema V2 ergänzt nun eine atomare, regelgebundene Punktentscheidung ohne Gesamtsieger. Der Replay derselben 320 Paketzeilen liefert 1 Vorteil B, 7 Gleichwertigkeiten, 9 nicht vergleichbare und 303 unklare Punkte. Gesamtregression, Format und Frontend-Build bestehen auf dem Mac Studio. Ein frischer Lauf und Release Candidate stehen aus. Das bleibt ein begrenzter Fixture-Beweis, keine 99-Prozent- oder Fremdversichererfreigabe. | [V3-Tracker, Abschnitt 68](../polizzenvergleich-v3/docs/POLIZZENANALYSE_IMPLEMENTIERUNGS_TRACKER_DE.md#68-regelgebundene-punktentscheidung-wer-ist-warum-besser), [ADR-021](./POLIZZENVERGLEICH_ENTSCHEIDUNGEN.md#adr-021-vorteile-sind-punktweise-atomar-und-regelgebunden), [Tests, Abschnitt 44](./POLIZZENVERGLEICH_TESTS_UND_ERKENNTNISSE.md#44-regelgebundene-punktentscheidung-v2) |
