...
| Aktueller V3-Beweisstand | RC33 aktiviert den gemeinsamen evidenzgebundenen Pfad für alle acht Ansichten. Auf der Kundenhardware terminiert der exakt installierte Tag für LF und WEVIG jeweils 320/320 Zeilen. Der zusätzliche exakte WEVIG-Vergleich `v3.2.1` gegen RC33 umfasst ebenfalls 320/320 Zeilen und zeigt den entscheidenden Fehlertypwechsel: weniger unzulässige Scope-/Wertzusammenschlüsse, aber konkrete Kandidatenverluste. Der erste allgemeine R1-Konzeptgruppen-Schnitt gewinnt auf Qwen 27B genau vier bekannte LW-Zeilen zurück, lässt die übrigen 32 Kernzeilen stabil und hält LW-31 sicher offen. Öffentliche UNIQA-/DONAU-Unterlagen liefern positive Wortlaut- und Nichtaktivierungsevidenz, aber kein vollständiges Vertragsoracle. Deshalb besteht weiterhin keine 99-Prozent-Freigabe. | [V3.2.1–RC33/R1-Befund](../polizzenvergleich-v3/docs/V321_RC33_R1_GENERALISIERUNGSBEFUND_DE.md), [V3-Tracker, Abschnitt 64](../polizzenvergleich-v3/docs/POLIZZENANALYSE_IMPLEMENTIERUNGS_TRACKER_DE.md#64-v321-vollvergleich-und-r1-konzeptgruppen-für-unbekannte-wortlaute), [RC33-Releasevertrag](../polizzenvergleich-v3/docs/RELEASE_V3.3.0_RC33_DE.md) |
...
| V3-Workspace-Fachvorlagen | `v3.2.0` ist Rückkehrbasis, die UI-Nachfolge `v3.2.1`; die CLI-Preset-Tags `v3.3.0`/`v3.3.1` werden zurückgezogen. Die acht Vorlagen `VS/FE/LW/ST/EL/HP/VB/WE` werden optional im normalen Workspace-Dialog gewählt; ohne Auswahl bleibt der AnythingLLM-Defaultprompt. Thread-Routerfix und Browser-Smoke sind verifiziert. | [ADR-019](./POLIZZENVERGLEICH_ENTSCHEIDUNGEN.md#adr-019-fachvorlagen-werden-beim-normalen-workspace-anlegen-ausgewählt), [Projektgedächtnis](./POLIZZENVERGLEICH_PROJEKTGEDAECHTNIS.md#v3-workspace-fachvorlagen) |
